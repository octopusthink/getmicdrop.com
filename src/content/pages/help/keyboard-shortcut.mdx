...
Your shortcut must start with at least one modifier key (unless you're using a function key).
...
If you'd like to use a function key (F6, F10, etc), you don't need a modifier key—you can use the function key on its own.
...
## Can I use the microphone button (F5) on my new MacBook?

Yes, you can! If you'd like to use the other function keys for their special functions (ie, changing volume or brightness) you'll want to use Karabiner Elements to remap your f5 key only.

Here's how you do it:

1. Install Karabiner Elements. Open Preferences > Function Keys.
2. map the F5 key to F5 instead of Dictation.
3. Open Mic Drop's preferences.
4. Record a new shortcut and use the F5 key.
5. You're good to go!
