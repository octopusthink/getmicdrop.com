...
**Using macOS Monterey?** There's a bug in macOS Monterey when using Bluetooth headphones. Any time a Bluetooth headset's mic is muted, the output is muted as well. We [reported this bug to Apple in August 2021](https://twitter.com/octopusthink/status/1431689504126078977), but it happens outside of Mic Drop so is up to Apple to fix. 😞
