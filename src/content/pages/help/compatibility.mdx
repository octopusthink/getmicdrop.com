...
**Using the macOS Monterey beta?** There's a bug in macOS Monterey beta when using Bluetooth headphones. Any time a Bluetooth headset's mic is muted, the output is muted as well. We've reported this bug to Apple, but it happens outside of Mic Drop so is up to Apple to fix. 😞
