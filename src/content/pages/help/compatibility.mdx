...
**Using macOS Monterey?** There's a bug in macOS Monterey when using Bluetooth headphones. Apple fixed this bug in macOS 12.4, so upgrade to that version to use your Bluetooth headphones with Mic Drop again.
