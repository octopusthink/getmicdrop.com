...
**Using macOS Monterey?** There's a bug in macOS Monterey when using Bluetooth headphones. We [shipped a workaround in version 1.4](/help/monterey-bluetooth), so if you update Mic Drop to the latest version you'll be able to use Mic Drop with Bluetooth headphones again! 🎉
