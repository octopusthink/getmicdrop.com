...
**Using macOS Monterey?** There's a bug in macOS Monterey when using Bluetooth headphones. We shipped [a workaround](/help/monterey-bluetooth) in version 1.4, so if you update to the latest version you'll be able to use your Bluetooth headphones again! 🎉
