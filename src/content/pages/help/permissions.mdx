...
In order to use the universal [keyboard shortcut](/help/keyboard-shortcut), Mic Drop needs permission to monitor your keyboard input. This sounds kinda scary, but it's actually just Apple protecting you against nefarious types. We *never, ever* record anything you type. (Check out our [privacy policy](/privacy).)
...
<iframe src="https://player.vimeo.com/video/402740582" width="640" height="463" frameborder="0" allow="autoplay; fullscreen" allowfullscreen></iframe>
...
When a prompt asks you to restart, you can just say "Later". Mic Drop will restart on its own when it needs to.
