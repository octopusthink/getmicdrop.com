...
[^1]: The **Logitech HD C920 Pro webcam** has a driver issue unrelated to Mic Drop. If you mute your C920 webcam, then put your Mac to sleep or change microphones with the webcam still muted, it will stay muted until you unplug it and plug it back in. Unfortunately, we can't fix this issue as it's not caused by Mic Drop (it happens with any app that mutes the C920).
