...
<div>
  <Image
    alt="Mute error notification (microphone icon with exclamation mark)"
...
Unfortunately this means that, for the time being, the only solution is to purchase a compatible wired microphone. Alternatively, if you have a USB device that isn't compatible, you can try [using Loopback to create a virtual audio device](/help/using-loopback).
