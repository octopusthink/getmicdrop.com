...
![Google Meet screen with settings expanded](images/bluetooth-fix-meet-1.png)

![Animation changing input in Google Meet from AirPods to Default Input Device](images/bluetooth-fix-meet-2.png)
