...
Mic Drop is a super-simple little Mac menubar app made by your friends at [Octopus Think Ltd.](https://octopusthink.com/about) 
...
By default, we don't collect any data about your use of the app. But we like data, so if you agree to share usage & crash report data, here's what we'll collect:

- Anonymous usage statistics.
- The version number of Mic Drop you're using.
- The type of Mac you have and the version of macOS you're running.

This data will never be shared or sold and will only be used to make Mic Drop better.
