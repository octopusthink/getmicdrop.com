...
Mic Drop has access to the audio input devices on your Mac—this lets Mic Drop detect new audio devices, mute/unmute input devices, and check on the status of input devices. **Mic Drop never records audio, saves audio as a file, listens to you or your Mac's input, or monitors the output devices of your Mac to listen to what you can hear.**
