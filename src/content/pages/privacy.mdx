...
**Mic Drop never records audio**, saves audio as a file, or listens to you. Mic Drop monitors input _devices_ only, never their content.
...
If you signed up to the Mic Drop beta, we save your email in MailChimp and use MailChimp to send you beta updates and surveys. You can opt-out at any time, and we won't sell your info or use your email for any other mailing list.

We disable MailChimp's email tracking so we are not monitoring how/when you read our beta emails or your interactions with the emails.

## Billing info

**We don't collect, store, or process your billing information** in any way and we don't have access to your credit card information. Payment is processed via [Paddle](https://paddle.com/) or Apple (via the Mac App Store).
