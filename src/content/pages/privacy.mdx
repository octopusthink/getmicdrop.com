...
<Paragraph>
    We don't collect, store, or process your billing information and we don't have access to your credit card information. Payment is processed by <Link as="a" href="https://paddle.com/" external>Paddle</Link>. If you <Link as="a" href="https://apps.apple.com/app/mic-drop/id1489816366" onClick={() => {
...
If you consent, we use cookies on this website to track anonymous, basic analytics and site usage. We also use cookies in the checkout process.
